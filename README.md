...
##Python File
The .py file contains the Python code used to screen and filter the literature data. It reads the Scopus export, searches for resilience-related terms in paper titles and abstracts, and organises the results into filtered output file.

##CSV File
The .csv file contains the analysed literature used in this paper. It presents the collected papers records that form the basis for the review.
